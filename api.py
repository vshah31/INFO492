...
nltk.download('wordnet', quiet=True)  # Add this line
nltk.download('omw-1.4', quiet=True)  # Add this line for Open Multilingual WordNet
...
def load_model():
    ...
    try:
        ...
        # Load the FastMisinfoClassifier
        ...
        # Initialize ChatGroq classifier
        ...
        if chatgroq_api_key:
            ...
            # Create ensemble with more balanced weights: 0.4 for FastMisinfo and 0.6 for ChatGroq
            # This is more balanced than the previous 0.3/0.7 split
            ...
            # Fallback to just the FastMisinfoClassifier if no API key
